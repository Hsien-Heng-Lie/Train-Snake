...
indexController.get("/game", authentication_middleware_1.ensureAuthenticated, (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "../../client/markup/game.html"));
});
indexController.get("/scores", authentication_middleware_1.ensureAuthenticated, (req, res) => {
